    ...
    <div class="wrap">
        ...
        <!-- {{detailsList}} -->
            ...
            <div class="petailsTabel">
                <div class="top">
                    <p v-for="(v,i) in detailsTabel" @click="tabels(i)">{{v}}</p>
                </div>
                <div class="tabelContent" v-for="(v,i) in tabList">
                    <!-- {{v.car_name}} -->
                    <div class="title">
                    ...
                    <div class="Dcontent">
                        ...
                        <div class="contentBottom" @click="gobottomPrice">询问底价</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer" @click="gobottomPrice">
            <p>询问底价</p>
            <h5>本地经销商为你报价</h5>
        </div>
    </div>
