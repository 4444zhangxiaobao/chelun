<template>
    <div class="carK">
        ...
        <div class="carCenter">
            <div class="centerT" >
                <p v-for="(v,i) in titleList" @click="carK(i)">{{v}}</p>
            </div>
            <div class="centerC">
                <div class="centerO" v-for="(v,i) in carKList">
                    <p>
     ...
     export default {
      ...
      data(){
        ...
        methods:{
            ...
            Creplice:function(e){
                let Rcontent = e.target.outerText
                window.sessionStorage.setItem('Rcontent',Rcontent)
